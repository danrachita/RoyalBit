...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Crypto-Developer/ROBI/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/Crypto-Developer/ROBI.SIGS.git
    git clone https://github.com/Crypto-Developer/ROBI-DETACHED.SIGS.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/Crypto-Developer/ROBI.git
